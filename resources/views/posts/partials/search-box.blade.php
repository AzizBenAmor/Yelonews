...
x-on:keyup.enter="$dispatch('search',{
    ...
    <div>
        ...
        <div class="w-52 flex rounded-2xl bg-gray-100 py-2 px-3 mb-3 items-center">
            ...
            <input
                x-model="query" class="w-40 ml-1 bg-transparent focus:outline-none focus:border-none focus:ring-0 outline-none border-none text-xs text-gray-800 placeholder:text-gray-400"
